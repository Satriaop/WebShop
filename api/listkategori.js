...
export default async function handler(req, res) {
    ...
    try {
        ...
        // 2. Ambil semua produk (struktur: products/{token}/{prodId})
        ...
        if (snapshot.exists()) {
            ...
            for (const token in allData) {
                ...
                for (const prodId in ownerProducts) {
                    ...
                    if (p && p.kategori && typeof p.kategori === 'string') {
        ...
        // Kembalikan array kosong jika tidak ada kategori — bukan 404
        ...
        console.error("API Error listkategori:", error);
